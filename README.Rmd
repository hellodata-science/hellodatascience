...
**hellodatascience** is a package to supplement the upcoming open-access *Hello Data Science* book. It contains datasets that are used in the book. You can find documentation on the [package website](https://hellodata-science.github.io/hellodatascience/).
