...
book](https://www.bayesrulesbook.com/). It contains datasets that are used in the book. You can find documentation on the [package website](https://hellodata-science.github.io/hellodatascience/docs/).
